        ...
        >
          <div>
            <div className="border-l-4 border-l-[#FE9430] mb-6">
              <h2 className="text-3xl sm:text-4xl font-extrabold text-[#621843] ms-2">
          ...
          <div>
            <button
              type="submit"
              className="bg-[#621843] text-white py-2 px-10 rounded-full shadow hover:cursor-pointer hover:bg-[#4e1334] transition"
            >
              Submit
            </button>
          </div>
