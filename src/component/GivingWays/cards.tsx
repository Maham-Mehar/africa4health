...
const Cards = () => {
  return (
    <div className="bg-white max-w-[83rem] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 p-6 mt-[60px]">
      {CardData.map((item) => (
        <div key={item.id} className="overflow-hidden group">
          <a href="mailto:hello@africaforhealth.org" className="hover:cursor-pointer">
