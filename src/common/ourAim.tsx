...
function JoinUs(props: aboutData) {
    return (
        <div className="py-15">
            ...
            <div
                className="bg-[#FE9430] bg-[url('/images/joinUS.png')] bg-cover bg-no-repeat text-white rounded-[2rem] max-w-7xl mx-auto py-12 px-8 md:px-12 gap-6">
                {/* Text Section */}
                ...
                <div className="flex text-center justify-center mt-7">
                    <button
                        className="text-xl font-semibold bg-white text-black px-8 py-3 rounded-full hover:bg-gray-100 transition">
                        {props.buttonText}
                    </button>
                </div>
            </div>
